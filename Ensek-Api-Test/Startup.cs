...
namespace Ensek_Api_Test
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IMeterAccountRepository, MeterAccountRepository>();
            services.AddDbContext<MeterAccountContext>(options =>
            {
                options.UseSqlServer(
                    Configuration["ConnectionStrings:MeterAccountConnection"]);
            });
